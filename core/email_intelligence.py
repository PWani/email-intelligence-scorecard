...
DEFAULT_SCORING_RULES = {
    ...
    "auto_archive_senders": {
        ...
        "entries": [
            ...
            "marketing@alpha-sense.com",
            "insights@marketing.intralinks.com",
            "contact@igsinsights.com",
            "mssecurity-noreply@microsoft.com",
            "transactions@dakota.com",
            "netsuite@na.netsuite.com",
            "newsletter@theorg.com",
            "e.email@dnb.com",
            "marketing-replyto@team.carta.com",
            "ajones@privateequityinfo.com",
            "events@acg.org",
            "communications@intapp.com",
            "cs@perksatwork.com",
            "glgamericasevents@glgroup.com",
            "marketing@thrivenextgen.com",
            "aqoxa@substack.com",
            "email@showcaseemail.fisglobal.com",
            "news@iqeq.com",
            "mail@e.adobe.com",
            "talent@selbyjennings.com",
            "hello@email.globalrelay.com",
            "backlink-audit@semrush.com",
            "alerts-noreply@alerts.pitchbook.com",
            "flyers@webstaurantstore.com",
            "notifications@globalrelay.net",
            "gustonoreply@gusto.com",
            "messages-noreply@linkedin.com",
            "noreply@campaign.eventbrite.com",
            "notifications-noreply@linkedin.com",
            "rob@dakotalive.com",
            "marketpulse@acuitykp.com",
            "site-audit@semrush.com",
            "mnolan@actelag.com",
            "lenovo@ecomm.lenovo.com",
            "b2b-no-reply@logitech.com",
            "no-reply@theorg.com",
            "noreply@uber.com",
            "noreply@clearstar.net",
            "notifications@communityhub.microsoft.com",
            "kmageras@thebraffgroup.com",
            "uber@uber.com",
            "cory@fincompliance.io",
            "no-reply@outlook.mail.microsoft",
            "no-reply@microsoft.com",
            "teamtrinet@comms.trinet.com",
            "demand@info.adobe.com",
            "news@dakota.com",
            "news@alterdomus.com",
            "noreply@semrush.com",
            "mail@email.adobe.com",
            "hannahcalandra1@178543098.mailchimpapp.com",
            "noreply@hubspot.com",
            "b2bdata@mkt.zoominfo.com",
            "paul.santiago@9627910.brevosend.com",
            "adpmajoraccounts@adp.com",
            "communications@ramp.com",
            "noreply@news.paypal.com",
            "data@pitchbook.com",
            "events@dakotalive.com",
            "dakotainsights@dakotalive.com",
            "sap@mailsap.com",
            "charlie.tian@gurufocusinvestments.com",
            "threatwire@mtradecraft.net",
            "moskal@livingstonepartners.com",
            "reply@rsmus.com",
            "info@go.49ers.com",
            "outreach@pnwfundraising.com",
            "no-reply@useloom.com",
            "info@withintelligence-email.com",
            "no-reply@business.amazon.com",
            "carta@team.carta.com",
            "nicholas@blockwaresolutions.com",
            "lee.whiteley@latitudeworld.com",
            "info@americanmedspa.org",
            "jconway@bscne.co",
            "ron@premierrecognition.com"
        ]
    }
}
